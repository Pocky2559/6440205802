...
public class UnitsResourcesSpend : MonoBehaviour //this script manage the training of unit. it will calculate resources and time to train
                                                 // this script work with button OnClick();
{
